...
# DNS Configuration for Auth Service
# This script creates DNS A record for github.com/bbapp-org/auth-service pointing to Traefik LoadBalancer
...
echo "🌐 Setting up DNS for Auth Service"
echo "Zone: ${ZONE_NAME}"
...
echo "🔗 Auth service will be available at: https://${FULL_DOMAIN}"
echo "📝 Update your ingress to use domain: ${FULL_DOMAIN}"
